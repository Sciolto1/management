...
| 模块名称 | 需求描述 | 未实现原因 |
| :--- | :--- | :--- |
| 人员调动管理 | 公司外调动、公司内调动（部门间人员调动、人员增加、人员离退、人员除名），离退除名人员保留全部信息，调动时工资及个人信息自动修改 | 系统未包含人员调动相关实体和业务逻辑 |
...
| 功能类别 | 需求功能 | 当前状态 |
| :--- | :--- | :--- |
| 部门信息 | 部门编码、部门备注 | 未实现，当前仅有名称、负责人、描述 |
| 人员基本信息 | 照片、职工编号、年龄、性别、出生日期、民族、政治面貌、婚否 | 未实现，当前仅有姓名、部门、职位、电话、邮箱 |
| 人员教育信息 | 职称、专业、学历、毕业学校、毕业时间 | 未实现 |
| 人员工作信息 | 身份证号、班组、入厂时间、参加工作时间、类别（工人、干部、临时工） | 未实现 |
| 人员合同信息 | 合同期限（起止时间） | 未实现 |
| 人员家庭信息 | 家庭住址 | 未实现 |
| 查询统计 | 根据任意项目进行查询、统计并形成报表 | 部分实现，仅有基础查询，无复杂统计和报表功能 |
