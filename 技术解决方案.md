...
```
┌──────────────┐         ┌──────────────┐         ┌──────────────┐
│  Employee    │         │  Department  │         │  SysUser     │
│  (实体类)    │         │  (实体类)    │         │  (实体类)    │
├──────────────┤         ├──────────────┤         ├──────────────┤
│ -id: Integer │         │ -id: Integer │         │ -id: Integer │
│ -name: String│         │ -name: String│         │ -username:   │
│ -dept: String│         │ -manager:    │         │   String     │
│ -position:   │         │   String     │         │ -password:   │
│   String     │         │ -desc: String│         │   String     │
│ -phone:      │         ├──────────────┤         │ -role: String│
│   String     │         │ +getManager()│         │ -empId:      │
│ -email:      │         │ +setManager()│         │   Integer    │
│   String     │         └──────────────┘         └──────────────┘
│ -hireDate:   │              ▲                        │
│   LocalDate  │              │                        │
│ -username:   │              │                        │
...
└──────────────┘              │                        │
     ...
     ▼  ▼
┌──────────────┐         ┌──────────────┐         ┌──────────────┐
│EmployeeService│        │AttendanceService│       │LeaveRequestService│
│ (业务服务类) │         │  (业务服务类) │         │  (业务服务类) │
├──────────────┤         ├──────────────┤         ├──────────────┤
│+list()       │         │+clockIn()    │         │+apply()      │
│+add()        │         │+clockOut()   │         │+approve()    │
│+update()     │         │+getByEmpId() │         │+getList()    │
│+delete()     │         │+updateStatus()│         └──────────────┘
└──────────────┘         └──────────────┘
     │                        │
     │                        │ Controller层 (控制类)
...
│+getList()    │         │+clockIn()    │
│+addEmp()     │         │+clockOut()   │
│+updateEmp()  │         │+getRecords() │
│+deleteEmp()  │         │+updateStatus()│
└──────────────┘         └──────────────┘
```
